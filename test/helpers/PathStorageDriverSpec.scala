...
class PathStorageDriverSpec extends Specification with org.specs2.mock.Mockito {
  sequential
  private val mock_storage = StorageEntry(None,Some("localtestnick"),None,None,"Local",None,None,None,None,None,supportsVersions=false,Some(StorageStatus.ONLINE))
